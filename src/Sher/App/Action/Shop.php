...
class Sher_App_Action_Shop extends Sher_App_Action_Base implements DoggyX_Action_Initialize {
	...
	protected $exclude_method_list = array('execute','speaker','headset','wireless','hifi','getlist','view','gallery','specs');
    ...
    public function getlist() {
		$pager_url = Doggy_Config::$vars['app.url.shop'].'/getlist?gid=%d&category_id=%d&page=#p#';
		$this->stash['pager_url'] = sprintf($pager_url, $this->stash['gid'], $this->stash['category_id']);
     ...
     * 显示列表
     */
    protected function _display_tab_list($tab_lab='speaker') {
